    ...
    namespace Profiler {
        ...
        public:
            ...
            double getCallsPerSecond() const {
                return _callPerSecond;
            }

            double getMeanCallPerSecond() const {
                return _meanCallPerSecond;
            }

            double getPercentageTime() const {
                return _percentageTime;
            }
            ...
            bool operator > (const StackSummary &summary) const {
                return (_totalTime > summary._totalTime);
            }
